...
# PARAMS['FASTER_RCNN_YAML'] = '../../configs/coco2017/supervised_compression/ghnd-bq/faster_rcnn_resnet50-bq9ch_fpn_from_faster_rcnn_resnet50_fpn.yaml'
# PARAMS['FASTER_RCNN_YAML'] = '../../configs/coco2017/supervised_compression/ghnd-bq/faster_rcnn_resnet50-bq12ch_fpn_from_faster_rcnn_resnet50_fpn.yaml'
